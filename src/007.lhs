...
The definition of `primesTo` comes from wiki.haskell.org/Prime_numbers. This
one strikes a nice balance between speed and readability (there are many more
optimisations that could be made, at the expense of the latter).
