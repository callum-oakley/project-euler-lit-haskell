-- We'll represent the triangle as a nested list. Actually calculating the
-- maximum total from top to bottom can be done in one pass, folding from
-- bottom to top and accumulating the maximum totals.
