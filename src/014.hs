...
-- and we want to know the Collatz length of 40, it is unnecessary to
-- recalculate the Collatz length of 20. We can do a lot better by calculating
-- every Collatz length we care about together, and referencing values we
-- already know.
--
-- To that end, the following function populates an array of the Collatz
-- lengths of all the numbers from 1 to its input.
